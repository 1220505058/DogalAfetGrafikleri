...
file_path = r"C:\Users\sümeyye\Desktop\Merve_Mızraklı_1220505052---Sümeyye_Polat_1220505058\Python_odev\natural_disasters_2024 (1).csv"
...
print(data.head())  # İlk 5 satırı yazdırıyoruz
print("\nVeri setinin genel bilgileri:")
data.info()  # Veri setinin yapısını ve her sütunun tipini yazdırıyoruz
print("\nEksik değerlerin sayısı:")
print(data.isnull().sum())  # Eksik değerlerin sayısını kontrol ediyoruz
...
disaster_counts = data["Disaster_Type"].value_counts()  # Afet türlerinin sıklığını hesaplıyoruz
...
# Pandas'tan NumPy dizilerine veri aktarımı
magnitudes = np.array(data["Magnitude"])  # Büyüklük sütununu NumPy dizisine dönüştürme
fatalities = np.array(data["Fatalities"])  # Ölümler sütununu NumPy dizisine dönüştürme
disaster_types = np.array(data["Disaster_Type"])  # Afet türlerini NumPy dizisine dönüştürme

# Dağılım grafiği oluşturma
plt.figure(figsize=(10, 6))
sns.scatterplot(x=magnitudes, y=fatalities, hue=disaster_types, palette="viridis")  # NumPy dizileriyle grafik oluşturma
...
# Pasta grafiği ile en çok ölüm yaşanan ülkeler
...
# 5. Ülkelere Göre Toplam Ekonomik Kayıplar (Yatay Çubuk Grafiği)
...
# 6. Her Afet Türü İçin Ortalama Ekonomik Kayıp
...
# 7. En Düşük Büyüklükteki 5 Afet
...
# En düşük büyüklükteki afet türlerinin dağılımı (Pasta Grafiği)
...
# 8. Ölümlerle Ekonomik Kayıplar Arasındaki İlişki
...
# 9. Afet Büyüklüklerinin Dağılımı (Histogram)
...
# 10. Afet Türlerine Göre Ekonomik Kayıp (Box Plot)
